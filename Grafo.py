...
class Graph:
    ...
    def __init__(self):
        ''' Se empieza la inicializacion de la matriz de adyacencia, que tendra el tiempo base que 
        tarda llegar de un nodo a otro, dejando en 0 el tiempo en llegar de un nodo a si mismo y 
        asignando un numero positivo muy grande (999) en las otras posiciones, pues muchos de los 
    ...
    def initMatrix(self):
        '''Se continua la inicializacion de la matriz de adyacencia. Como la matriz es simetrica, 
        se rellena el cuadrante de abajo primero porque sus coordenadas son mas faciles de leer 
        en relacion a la cuadricula y luego con el se rellena el cuadrante superior'''
